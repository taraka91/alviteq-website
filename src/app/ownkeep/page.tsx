...
export default function OwnKeepPage() {
  return <><PageHero eyebrow="OwnKeep" title="Keep what matters. Only you. Always." intro="OwnKeep organizes documents and important life information inside an encrypted, offline-capable vault." action={{label:"Ask about OwnKeep",href:"/contact"}} />
