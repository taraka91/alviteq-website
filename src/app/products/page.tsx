...
export default function ProductsPage() {
  return <><PageHero eyebrow="Products by Alviteq" title="Focused tools for information that matters." intro="Alviteq is the company behind OwnKeep. Our products combine careful interaction design, local intelligence, and privacy-conscious engineering." action={{label:"Explore OwnKeep",href:"/ownkeep"}} />
    <section className="section container"><div className="product-showcase"><div><Image className="product-icon" src="/images/ownkeep-icon.png" width={150} height={150} alt="OwnKeep application icon" /><p className="eyebrow">An Alviteq product</p><h2>OwnKeep</h2><p className="lead">An encrypted personal life vault for documents, extracted details, reminders, connected records, and passwords.</p><div className="platform-list"><span>Android</span><span>iOS</span><span>macOS</span><span>Windows</span><span>Linux</span></div></div><Image className="vault-art" src="/images/ownkeep-vault.png" width={750} height={1000} alt="OwnKeep encrypted vault illustration" /></div></section>
