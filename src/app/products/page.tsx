...
export default function ProductsPage() {
  return <><PageHero eyebrow="Products by Alviteq" title="Technology becomes meaningful when it solves something real." intro="We build focused digital products around clear everyday problems." action={{label:"Explore OwnKeep",href:"/products/ownkeep"}} />
    <section className="section container"><div className="product-showcase"><div><Image className="product-icon" src="/images/ownkeep-icon.png" width={150} height={150} alt="OwnKeep application icon" /><p className="eyebrow">Available product</p><h2>OwnKeep</h2><p className="lead">A private digital space for documents, records, reminders, passwords, and important life information.</p><div className="platform-list"><span>Android</span><span>iOS</span><span>macOS</span><span>Windows</span><span>Linux</span></div><Link className="button" href="/products/ownkeep">Discover OwnKeep</Link></div><Image className="vault-art" src="/images/ownkeep-vault.png" width={750} height={1000} alt="OwnKeep encrypted vault illustration" /></div></section>
